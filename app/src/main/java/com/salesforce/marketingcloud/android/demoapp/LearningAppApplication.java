...
import com.salesforce.marketingcloud.proximity.BeaconLogger;
...
public class LearningAppApplication extends Application implements MarketingCloudSdk.InitializationListener,
    ...
    public void onCreate() {
        ...
        MarketingCloudSdk.init(this, MarketingCloudConfig.builder() //
                ...
                .setApplicationId("a48b9de6-6803-4d1a-83e1-fc2e5ea4fc0f") // ENTER YOUR MARKETING CLOUD APPLICATION ID HERE
                .setAccessToken("rz6ehn3jw8uv72va7ykuhpj6") // ENTER YOUR MARKETING CLOUD ACCESS TOKEN HERE
                .setSenderId("488449775416") // ENTER YOUR GOOGLE SENDER ID HERE
        ...
        // Pipe AltBeacon's logs through the MarketingCloud MCLogListener interface.
// This will adhere to the log level set by MarketingCloudSdk.setLogLevel()
        LogManager.setLogger(new BeaconLogger());
